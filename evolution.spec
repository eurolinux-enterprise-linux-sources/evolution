...
* Wed Jan 09 2013 Milan Crha <mcrha@redhat.com> - 2.28.3-29.el6
- Add patch for RH bug #890642 (Crash due to implicit function declarations)

* Mon Jan 07 2013 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-28.el6
- Add patch for RH bug #885558 (CVE 2011-3201).

* Fri Sep 07 2012 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-27.el6
- Add patch for RH bug #805239 (calendar alarm notifications).

* Fri Sep 07 2012 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-26.el6
- Add patch for RH bug #707526 (contact_list_editor_render_destination)

* Wed Apr 27 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-24.el6
- Rework the patch for RH bug #686881 - upstream solution is flawed.

* Wed Apr 20 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-23.el6
- Add patch for RH bug #696881 (crash during mail migration).

* Mon Mar 21 2011 Milan Crha <mcrha@redhat.com> - 2.28.3-22.el6
- Update patch for RH bug #666875 (crash when viewing large message)

* Mon Mar 07 2011 Milan Crha <mcrha@redhat.com> - 2.28.3-21.el6
- Add patch for RH bug #633189 (be able to use input methods in memos/tasks)

* Wed Feb 02 2011 Milan Crha <mcrha@redhat.com> - 2.28.3-20.el6
- Add versioned evolution-conduits to evolution-devel Requires
- Add nss/nspr libraries to LDAP_LIBS, because latest openldap requires it

* Fri Jan 28 2011 Milan Crha <mcrha@redhat.com> - 2.28.3-19.el6
- Update patch for RH bug #585931 (Added translations)

* Tue Jan 25 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-18.el6
- Add patch for RH bug #667083 (crash when replying to meeting).

* Fri Jan 21 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-17.el6
- Add patch for RH bug #666875 (crash when viewing large message).

* Tue Jan 18 2011 Milan Crha <mcrha@redhat.com> - 2.28.3-16.el6
- Add patch for RH bug #585931 (Calendar editor toolbar tooltips)

* Mon Jan 10 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-15.el6
- Add patch for RH bug #628964 (calendar printing improvements).

* Mon Jan 10 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-14.el6
- Add patch for RH bug #633629 (crash in mail-to-task plugin).

* Mon Jan 10 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-13.el6
- Add patch for RH bug #633600 (broken account option mnemonic).

* Sun Jan 09 2011 Matthew Barnes <mbarnes@redhat.com> - 2.28.3-12.el6
- Add patch for RH bug #632968 (hide Help -> Submit Bug Report).

* Mon Dec 20 2010 Milan Crha <mcrha@redhat.com> - 2.28.3-11.el6
- Add patch for RH bug #628882 (Update zh_TW translation)

* Wed Dec 08 2010 Milan Crha <mcrha@redhat.com> - 2.28.3-11.el6
- Add patch for RH bug #632998 (Update hi translation)
- Add patch for RH bug #638643 (Update ta translation)
- Add patch for RH bug #630314, RH bug #630316 (Update ml translation)
- Add patch for RH bug #633181 (Update zh translation)
